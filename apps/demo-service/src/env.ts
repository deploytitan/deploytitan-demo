...
export const CORE_SERVICE_NAME = process.env['SERVICE_NAME'] ?? 'core-api-service';
...
export const OTLP_FLUSH_MS = parseInt(process.env['OTEL_FLUSH_INTERVAL_MS'] ?? '5000', 10)
